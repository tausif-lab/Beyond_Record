      ...
      <Card>
        ...
        <CardContent>
          <div className={`p-4 rounded-lg ${
            teacherStudentRatio > 0 ? 'bg-blue-50 border-blue-200' : 'bg-yellow-50 border-yellow-200'
          } border`}>
          ...
          {calculations && (
            <div className="p-6 border rounded-lg bg-blue-50">
              ...
              <div className="bg-white p-4 rounded border">
                <h5 className="font-semibold text-gray-800 mb-3">Criteria-wise CGPA (4.0 Scale)</h5>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                  {Object.entries(calculations.criteriaScores || {}).map(([criteria, cgpa]) => (
                    <div key={criteria} className="flex justify-between items-center p-2 bg-gray-50 rounded">
                      ...
                      <span className="font-bold text-blue-600">{cgpa}</span>
                    </div>
                  ))}
                </div>
              </div>
